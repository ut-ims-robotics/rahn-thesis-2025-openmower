...
StateSubscriber<std_msgs::Bool> radar_obstacle_subscriber("/radar/obstacle_detected");
...
// Handles the radar obstacle detection emergency - Karl
void radarEmergencyCallback(const std_msgs::Bool::ConstPtr& msg) {
    ROS_WARN_STREAM("Radar emergency trigger received: " << msg->data);
    setEmergencyMode(msg->data);
}
...
int main(int argc, char **argv) {
  ...
  radar_obstacle_subscriber.Start(n);
